        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Buskets_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Buskets_Tours_TourId",
                        column: x => x.TourId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FileModels_Tours_TourId",
                        column: x => x.TourId,
                        principalTable: "Tours",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TourId = table.Column<int>(nullable: false),
                    ApplicationUserId = table.Column<string>(nullable: true),
                    CityEnum = table.Column<int>(nullable: false),
                    TypeOfFood = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Buskets_ApplicationUserId",
                table: "Buskets",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Buskets_TourId",
                table: "Buskets",
                column: "TourId");
